若没有增加新的大区服务器，不会维护更新。现有数据能满足大部分更新检测，需求更精准的数据请认真看完以下教程自行添加数据   
检测原理Socket较稳定，实际使用效果根据个人自身电脑网络情况决定，即使游戏客户端也是如此！  
年久失更，遇到bug请QQ联系我，下载程序请看发布Releases
# V202.0.3-稳定版  
 作者提示：此版本为稳定版未完善
